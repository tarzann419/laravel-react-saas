            ...
            <div className="py-8 px-4">
                <div className="text-center mb-8">
                    <h2 className="mb-4 text-4xl font-extrabold text-white">
                        The more credits you purchase, the more you save!
                    </h2>
                </div>
                    ...
                    {packages.map((p) => (
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <button
                                    className="bg-blue-600 hover:bg-blue-700 focus: ring-4 font-medium rounded-1g text-sm px-5 py-2.5 text-center text-white focus: ring-blue-900 w-full"
                                >
                                    Get started
                                </button>
                            </form>
